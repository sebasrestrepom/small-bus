...
export class initial1679110693428 implements MigrationInterface {
    name = 'initial1679110693428'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rider" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "payment_source_id" integer NOT NULL, CONSTRAINT "PK_1ed6540e613592e2a470a162ef1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "reference" character varying NOT NULL, "payment_id" integer NOT NULL, "status" character varying NOT NULL, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
